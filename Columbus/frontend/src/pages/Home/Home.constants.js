export const post1 = {
    ...
    time_start: "1970-12-13",
    time_end: '1975-12-13',
    title: 'A Story about Craziness',
    locations: [{ 'location': 'Afyonkarahisar' }],
...
export const post2 = {
    ...
    locations: [{ 'location': 'Ankara' }, { 'location': 'İstanbul' }],
...
export const post3 = {
    ...
    time_end: '1975-12-13',
    title: 'Cats are Amazing',
    locations: [{ 'location': 'Boğaziçi Üniversitesi Güney Kampüs' }, { 'location': 'İstanbul' }, { 'location': 'Edirne' }],
    tags: ['cat', 'love', 'terminal'],
    multimedia: []
}
export const post4 = {
    ...
    time_end: '1975-12-13',
    title: 'Cats are Amazing',
    locations: [{ 'location': 'Ankara' }, { 'location': 'İstanbul' }, { 'location': 'Edirne' }, { 'location': 'Atina' }],
    tags: ['cat', 'love', 'terminal'],
    multimedia: ['https://images.pexels.com/photos/8264394/pexels-photo-8264394.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940']
}

export const dummyPosts = [post1, post2, post3, post4]