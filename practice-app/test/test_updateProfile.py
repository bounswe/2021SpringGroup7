...
class TestStringMethods(unittest.TestCase):
    ...
    def test_request(self):
        req = requests.post('http://127.0.0.1:5000/user/atainan/update')
        self.assertEqual(req.status_code, 500)

    def test_real_profile(self):
        req = requests.post('http://127.0.0.1:5000/user/atainan/update', {'first_name':'',
    ...
    def test_first_name_update(self):
        req = requests.post('http://127.0.0.1:5000/user/atainan/update', {'first_name':'testname',
            'last_name':'', 'email':'', 'location':'', 'birthday':'', 'isVisible':''})
